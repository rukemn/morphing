...
public class SvgExporter {
    ...
    private final SvgGenerator generator = new SvgGenerator(new SvgGenerator.Config(false, false, true, Color.green, Color.blue, Color.orange, Color.orange, Color.white));
