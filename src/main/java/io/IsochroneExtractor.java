package io;
/* todo dependency on vividsolutions jts version, and travel-time-maps project
...
public class IsochroneExtractor extends Main {

    private static List<Timezone<Point2D>> isochrone = new ArrayList<>();

    public static List<Timezone<Point2D>> getIsochrone() {
        return isochrone;
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (START_IDS != null) {
            ...
            FaceIdentifier.FaceFactory<?> faceFactory;
